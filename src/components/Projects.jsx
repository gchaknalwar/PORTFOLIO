...
// import bankingImg from "../assets/images/onlineBanking.png"; // Add your banking screenshot
import unisalonImg from "../assets/images/unisalon.png"; // Add your UNISALON screenshot
...
const projects = [
  {
    ...
    description:
      "A full-stack e-commerce application built with the MERN stack featuring product catalog, category-based filtering, shopping cart, secure JWT authentication, order management, and Razorpay/Stripe payment integration. Includes an admin dashboard for inventory, orders, and sales analytics.",
    image: ecommerceImg,
  ...
  },
  {
    ...
    description:
      "A secure banking application developed using Spring Boot and React.js with Spring Security authentication, role-based authorization, Hibernate/JPA, MySQL database, RESTful APIs, fund transfer, account management, and transaction history.",
    // image: bankingImg,
    github: "https://github.com/gchaknalwar",
    demo: "#",
  ...
  {
    id: 3,
    title: "UNISALON - Salon Booking Website",
    description:
      "A modern and responsive salon website built using React.js featuring online appointment booking, service listings, pricing, customer testimonials, contact section, smooth animations, and a clean mobile-first user interface.",
    image: unisalonImg,
    github: "https://github.com/gchaknalwar",
    demo: "#",
    tags: [
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16 md:mb-20 animate-fadeInUp">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto text-base sm:text-lg">
            ...
            focusing on performance, security, scalability, and clean UI.
          </p>
        </div>
            ...
            >
              <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl overflow-hidden hover:-translate-y-2 hover:border-orange-500/30 transition-all duration-500 h-full flex flex-col">
                ...
                <div className="p-6 flex-1 flex flex-col">
                  ...
                  <p className="text-gray-400 text-sm mt-4 flex-1 leading-6">
                    {project.description}
                  </p>
